...
function AvailableHomes({navigation}){
    ...
    const Cart = ({item}) => {
        return (
            <ScrollView>
                ...
                activeOpacity={0.9} 
                underlayColor={"white"} 
                onPress={()=> navigation.navigate("MoreAboutHome", item)}
            >
                <View style={styles.cartcard}>
                    ...
                    <View style={{
                        ...
                        <Text style={{fontWeight:'bold', fontSize:17}}>Available Slots : {item.availableSlots}</Text>
                    </View >
                </View>
            </TouchableHighlight>
            </ScrollView>
